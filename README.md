...
Check out [FRONTEND LIVE DEMO](https://sd-frontend.saviseui.repl.co/) here!!

Check out [API LIVE DEMO](https://sd-backend.saviseui.repl.co) here!!
...
1. Git Clone https://github.com/NicoleJones01/hunger-captain.git
